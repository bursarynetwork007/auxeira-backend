...
import { 
  ...
  UserX, UserPlus, UserMinus, RefreshCw, Layers, Radar as RadarIcon, Gauge, Pulse, Waves,
...
import { 
  ...
  BarChart, Bar, PieChart as RechartsPieChart, Cell, ScatterChart, Scatter as RechartsScatter,
...
export default function FerrariVCDashboard() {
  ...
  const tabs = [
    ...
    { id: 'market', label: 'Market Intel', icon: RadarIcon },
